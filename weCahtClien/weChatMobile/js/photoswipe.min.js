...
(function (e, t) {
	...
	var e = function (e, t, n, i) {
		...
		var a = this, r = 25, l = 3, s = {allowPanToNext:!0, spacing:0.12, bgOpacity:1, mouseUsed:!1, loop:!0, pinchToClose:!0, closeOnScroll:!0, closeOnVerticalDrag:!0, hideAnimationDuration:333, showAnimationDuration:333, showHideOpacity:!1, focus:!0, escKey:!0, arrowKeys:!0, mainScrollEndFriction:0.35, panEndFriction:0.35, scaleMode:"fit", modal:!0, alwaysFadeIn:!1};
		o.extend(s, i);
		var u, c, d, m, p, f, h, y, v, x, g, w, b, I, D, C, T, M, Z, S, A, k, O, E, R, F, P, L, z, N, _, U, H, Y, B, V, W, G, X, K, q, $, j, J, Q, et, tt, nt, it, ot, at, rt, lt, st, ut, ct, dt, mt, pt, ft, ht, yt, vt, xt, gt = function () {
			return {x:0, y:0};
		}, wt = 0, bt = gt(), It = gt(), Dt = gt(), Ct = gt(), Tt = {}, Mt = 0, Zt = 0, St = gt(), At = 0, kt = !0, Ot = [], Et = {}, Rt = function (e, t) {
			...
			if (!s.loop && t) {
				var n = m + (St.x * Mt - e) / St.x, i = Math.round(e - In.x);
			...
			var l = function () {
				an("initialZoom"), i || (_t(1), n && (n.style.display = "none"), o.addClass(e, "pswp--animated-in"), zt("initialZoom" + (i ? "OutEnd" : "InEnd"))), a && a(), ht = !1;
			}, u = i ? s.hideAnimationDuration : s.showAnimationDuration;
			return r && void 0 !== r.x && u ? (t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (x = r.w / t.w, Dt.x = r.x, Dt.y = r.y - L, s.showHideOpacity && (e.style.opacity = 0.001, e.style.webkitBackfaceVisibility = "hidden"), Ht()), rn("initialZoom"), i && !d && o.removeClass(e, "pswp--animated-in"), U = setTimeout(function () {
				if (zt("initialZoom" + (i ? "Out" : "In")), i) {
					var n = r.w / t.w, a = {x:Dt.x, y:Dt.y}, c = x, m = L, p = ct, f = function (t) {
					...
					x = t.initialZoomLevel, qt(Dt, t.initialPosition), Ht(), _t(1), s.showHideOpacity ? e.style.opacity = 1 : _t(1), U = setTimeout(l, u + 20);
				}
			}, i ? 25 : 90), !0) : (zt("initialZoom" + (i ? "Out" : "In")), x = t.initialZoomLevel, qt(Dt, t.initialPosition), Ht(), e.style.opacity = i ? 0 : 1, _t(1), l(), !1);
		}, cn = {shout:zt, listen:Lt, viewportSize:Tt, options:s, isMainScrollAnimating:function () {
			return at;
			...
			if (!u && !c) {
				...
				if (a.framework = o, a.template = e, a.bg = e.children[0], P = e.className, u = !0, _ = o.detectFeatures(), R = _.raf, F = _.caf, k = _.transform, z = _.oldIE, a.scrollWrap = e.children[1], a.container = a.scrollWrap.children[0], p = a.container.style, k) {
					...
					k = "left", o.addClass(e, "pswp--ie"), Bt = function (e, t) {
						t.left = e + "px";
					}, Yt = function (e) {
						var t = e.container.style, n = e.fitRatio * e.w, i = e.fitRatio * e.h;
						t.width = n + "px", t.height = i + "px", t.left = e.initialPosition.x + "px", t.top = e.initialPosition.y + "px";
					}, Ht = function () {
						if (ot) {
							var e = ot, t = a.currItem, n = t.fitRatio * t.w, i = t.fitRatio * t.h;
				...
				for (a.itemHolders = C = [{el:a.container.children[0], wrap:0, index:-1}, {el:a.container.children[1], wrap:0, index:-1}, {el:a.container.children[2], wrap:0, index:-1}], C[0].el.style.display = C[2].el.style.display = "none", O = _.pointerEvent, O && _.touch && (_.touch = !1), O ? navigator.pointerEnabled ? r("pointer", "down", "move", "up", "cancel") : r("MSPointer", "Down", "Move", "Up", "Cancel") : _.touch ? (r("touch", "start", "move", "end", "cancel"), E = !0) : r("mouse", "down", "move", "up"), h = Z + " " + S + " " + A, y = M, O && !E && (E = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = E, (!_.animationName || !_.transform || _.isOldIOSPhone || _.isOldAndroid || _.isMobileOpera) && (s.showAnimationDuration = s.hideAnimationDuration = 0), n = 0; Ot.length > n; n++) {
					a["init" + Ot[n]]();
				}
				if (t) {
				...
				var T;
				v = {resize:a.updateSize, scroll:function () {
				...
				var U = "pswp--open ";
				for (s.mainClass && (U += s.mainClass + " "), s.showHideOpacity && (U += "pswp--animate_opacity "), U += E ? "pswp--touch" : "pswp--notouch", U += _.animationName ? " pswp--css_animation" : "", U += _.svg ? " pswp--svg" : "", o.addClass(e, U), a.updateSize(), f = -1, At = null, n = 0; l > n; n++) {
					Bt((n + f) * St.x, C[n].el.style);
				}
				z || o.bind(a.scrollWrap, y, a), Lt("initialZoomInEnd", function () {
					a.setContent(C[0], m - 1), a.setContent(C[2], m + 1), C[0].el.style.display = C[2].el.style.display = "none", s.focus && e.focus(), $t();
				...
				}, 1000)), o.addClass(e, "pswp--visible");
			}
		}, close:function () {
			...
			if (!kt) {
				var n = o.getScrollY();
				if (N !== n && (e.style.top = n + "px", N = n), !t && Et.x === window.innerWidth && Et.y === window.innerHeight) {
					return;
				}
				Et.x = window.innerWidth, Et.y = window.innerHeight, e.style.height = Et.y + "px";
			}
			if (Tt.x = a.scrollWrap.clientWidth, Tt.y = a.scrollWrap.clientHeight, lt = {x:0, y:N}, St.x = Tt.x + Math.round(Tt.x * s.spacing), St.y = Tt.y, Vt(St.x * Mt), zt("beforeResize"), void 0 !== f) {
				for (var i, r, u = 0; l > u; u++) {
			...
			var s = x, u = {x:Dt.x, y:Dt.y}, c = function (t) {
		...
		}}, dn = 30, mn = 10, pn = {}, fn = {}, hn = {}, yn = {}, vn = {}, xn = [], gn = {}, wn = [], bn = {}, In = gt(), Dn = gt(), Cn = gt(), Tn = function (e, t) {
			...
			var n, i, o = 0, r = Dt[e] + t[e], l = t[e] > 0, u = In.x + t.x, c = In.x - gn.x;
			...
			if (Q) {
				...
				if (0 !== e) {
					if (qt(pn, Q[0]), hn.x = pn.x - yn.x, hn.y = pn.y - yn.y, et && e > 1) {
						if (yn.x = pn.x, yn.y = pn.y, !hn.x && !hn.y && Xt(Q[1], fn)) {
							return;
						}
						qt(fn, Q[1]), q || (q = !0, zt("zoomGestureStarted"));
						var t = Tn(pn, fn), n = Wt(t);
						...
						if (a.currItem.minZoom > n) {
							if (s.pinchToClose && !dt && a.currItem.initialZoomLevel >= g) {
								var o = a.currItem.minZoom - n, r = 1 - o / (a.currItem.minZoom / 1.2);
								_t(r), zt("onPinchClose", r), ut = !0;
							} else {
								i = (a.currItem.minZoom - n) / a.currItem.minZoom, i > 1 && (i = 1), n = a.currItem.minZoom - i * (a.currItem.minZoom / 3);
							}
						} else {
							n > a.currItem.maxZoom && (i = (n - a.currItem.maxZoom) / (6 * a.currItem.minZoom), i > 1 && (i = 1), n = a.currItem.maxZoom + i * a.currItem.minZoom);
						}
						...
						if (st && (st = !1, Math.abs(hn.x) >= mn && (hn.x -= Q[0].x - vn.x), Math.abs(hn.y) >= mn && (hn.y -= Q[0].y - vn.y)), yn.x = pn.x, yn.y = pn.y, 0 === hn.x && 0 === hn.y) {
							return;
						}
			...
			if (O) {
				...
				if (n > -1) {
					if (t = xn.splice(n, 1)[0], navigator.pointerEnabled) {
			...
			var r, l = Nn(e), s = l.length;
			if ("mouseup" === e.type && (s = 0), 2 === s) {
				return Q = null, !0;
			}
			1 === s && qt(vn, l[0]), 0 !== s || rt || at || (t || ("mouseup" === e.type ? t = {x:e.pageX, y:e.pageY, type:"mouse"} : e.changedTouches && e.changedTouches[0] && (t = {x:e.changedTouches[0].pageX, y:e.changedTouches[0].pageY, type:"touch"})), zt("touchRelease", e, t));
			var u = -1;
			if (0 === s && (X = !1, o.unbind(window, h, a), Mn(), et ? u = 0 : -1 !== wt && (u = Nt() - wt)), wt = 1 === s ? Nt() : -1, r = -1 !== u && 150 > u ? "zoom" : "swipe", et && 2 > s && (et = !1, 1 === s && (r = "zoomPointerUp"), zt("zoomGestureEnded")), Q = null, $ || q || at || W) {
				if (ln(), B || (B = Vn()), B.calculateSwipeSpeed("x"), W) {
					...
					if (!at) {
						return "swipe" !== r ? (Xn(), void 0) : (!J && x > a.currItem.fitRatio && Wn(B), void 0);
					}
				}
			}
		}, Vn = function () {
			var e, t, n = {lastFlickOffset:{}, lastFlickDist:{}, lastFlickSpeed:{}, slowDownRatio:{}, slowDownRatioReverse:{}, speedDecelerationRatio:{}, speedDecelerationRatioAbs:{}, distanceOffset:{}, backAnimDestination:{}, backAnimStarted:{}, calculateSwipeSpeed:function (i) {
				wn.length > 1 ? (e = Nt() - Y + 50, t = wn[wn.length - 2][i]) : (e = Nt() - H, t = vn[i]), n.lastFlickOffset[i] = yn[i] - t, n.lastFlickDist[i] = Math.abs(n.lastFlickOffset[i]), n.lastFlickSpeed[i] = n.lastFlickDist[i] > 20 ? n.lastFlickOffset[i] / e : 0, 0.1 > Math.abs(n.lastFlickSpeed[i]) && (n.lastFlickSpeed[i] = 0), n.slowDownRatio[i] = 0.95, n.slowDownRatioReverse[i] = 1 - n.slowDownRatio[i], n.speedDecelerationRatio[i] = 1;
			}, calculateOverBoundsAnimOffset:function (e, t) {
				n.backAnimStarted[e] || (Dt[e] > it.min[e] ? n.backAnimDestination[e] = it.min[e] : Dt[e] < it.max[e] && (n.backAnimDestination[e] = it.max[e]), void 0 !== n.backAnimDestination[e] && (n.slowDownRatio[e] = 0.7, n.slowDownRatioReverse[e] = 1 - n.slowDownRatio[e], 0.05 > n.speedDecelerationRatioAbs[e] && (n.lastFlickSpeed[e] = 0, n.backAnimStarted[e] = !0, sn("bounceZoomPan" + e, Dt[e], n.backAnimDestination[e], t || 300, o.easing.sine.out, function (t) {
					Dt[e] = t, Ht();
				}))));
				...
				return nn.zoomPan && (nn.zoomPan.raf = R(n.panAnimLoop), n.now = Nt(), n.timeDiff = n.now - n.lastNow, n.lastNow = n.now, n.calculateAnimOffset("x"), n.calculateAnimOffset("y"), Ht(), n.calculateOverBoundsAnimOffset("x"), n.calculateOverBoundsAnimOffset("y"), 0.05 > n.speedDecelerationRatioAbs.x && 0.05 > n.speedDecelerationRatioAbs.y) ? (an("zoomPan"), void 0) : void 0;
			}};
			return n;
		}, Wn = function (e) {
			return e.calculateSwipeSpeed("y"), it = a.currItem.bounds, e.backAnimDestination = {}, e.backAnimStarted = {}, 0.05 >= Math.abs(e.lastFlickSpeed.x) && 0.05 >= Math.abs(e.lastFlickSpeed.y) ? (e.speedDecelerationRatioAbs.x = e.speedDecelerationRatioAbs.y = 0, e.calculateOverBoundsAnimOffset("x"), e.calculateOverBoundsAnimOffset("y"), !0) : (rn("zoomPan"), e.lastNow = Nt(), e.panAnimLoop(), void 0);
		}, Gn = function (e, t) {
			var n;
			at || (Zt = m);
			var i;
			...
			var u, c = St.x * Mt, d = Math.abs(c - In.x);
		...
		}, Kn = {}, qn = {}, $n = [], jn = {index:0, errorMsg:"<div class=\"pswp__error-msg\"><a href=\"%url%\" target=\"_blank\">The image</a> could not be loaded.</div>", forceProgressiveLoading:!1, preload:[1, 1], getNumItemsFn:function () {
			return pt.length;
		}}, Jn = function (e, t, n) {
			if (e.src) {
				var i = !n;
				if (i && (e.vGap || (e.vGap = {top:0, bottom:0}), zt("parseVerticalMargin", e)), Kn.x = t.x, Kn.y = t.y - e.vGap.top - e.vGap.bottom, i) {
					var o = Kn.x / e.w, a = Kn.y / e.h;
					e.fitRatio = a > o ? o : a, e.fillRatio = o > a ? o : a;
					var r = s.scaleMode;
					"orig" === r ? n = 1 : "fit" === r ? n = e.fitRatio : "fill" === r && (n = e.fillRatio), n > 1 && (n = 1), e.initialZoomLevel = n, e.maxZoom = 2, e.doubleTapZoom = 2 * n > 1 ? 2 * n : 1, e.minZoom = n, e.bounds || (e.bounds = {center:{}, max:{}, min:{}});
				}
				if (!n) {
					return;
				}
		...
		Rt("Controller", {publicMethods:{lazyLoadItem:function (e) {
			e = Ft(e);
			var t = yt(e);
			...
			o.extend(s, jn, !0), a.items = pt = n, yt = a.getItemAt, vt = s.getNumItemsFn, xt = s.loop, 3 > vt() && (s.loop = !1), Lt("beforeChange", function (e) {
				var t, n = s.preload, i = null === e ? !0 : e > 0, o = Math.min(n[0], vt()), r = Math.min(n[1], vt());
				for (t = 1; (i ? r : o) >= t; t++) {
					a.lazyLoadItem(m + t);
				}
				for (t = 1; (i ? o : r) >= t; t++) {
			...
			if (r) {
				if (zt("gettingData", t, r), e.index = t, e.item = r, ti(r, e)) {
					return r.initialPosition.x = r.initialPosition.y = 0, r.initialZoomLevel = r.maxZoom = r.minZoom = 1, ot = null, r.w = 50, r.h = 50, Yt(r), void 0;
				}
				var l = r.container = o.createEl("pswp__zoom-wrap");
				if (r.loaded) {
					i = o.createEl("pswp__img", "img"), i.style.webkitBackfaceVisibility = "hidden", i.style.opacity = 1, i.src = r.src, Qn(t, r, l, i, !0);
				} else {
					if (r.loadComplete = function (n) {
						if (u) {
							if (n.img.style.webkitBackfaceVisibility = "hidden", e.index === t) {
								if (ti(n, e)) {
									return n.img = null, void 0;
								}
								n.imageAppended ? !ht && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : at || ht ? $n.push({item:n, baseDiv:l, img:n.img, index:t, holder:e}) : Qn(t, n, l, n.img, at || ht);
							}
					...
					r.loading || ei(r), a.allowProgressiveImg() && (ft ? Qn(t, r, l, r.img, !0, !0) : $n.push({item:r, baseDiv:l, img:r.img, index:t, holder:e}));
				}
		...
		var ii, oi = {}, ai = function (e, t, n) {
			var i = document.createEvent("CustomEvent");
			i.initCustomEvent("pswpTap", !0, !0, {origEvent:e, target:e.target, releasePoint:t, pointerType:n || "touch"}), e.target.dispatchEvent(i);
		};
		Rt("Tap", {publicMethods:{initTap:function () {
			...
			if (t && !$ && !K && !on) {
				var n = t;
				if (ii && (clearTimeout(ii), ii = null, Kt(n, oi))) {
					return zt("doubleTap", n), void 0;
				}
				var i = e.target.tagName.toLowerCase();
				if ("mouse" === t.type) {
					return ai(e, t, "mouse"), void 0;
				}
		...
		var ri;
		Rt("DesktopZoom", {publicMethods:{handleMouseWheel:function (e) {
			if (a.currItem.fitRatio >= x) {
				return !0;
			}
			if (e.preventDefault(), e.stopPropagation(), ri.x = 0, "deltaX" in e) {
				ri.x = e.deltaX, ri.y = e.deltaY;
			} else {
				if ("wheelDelta" in e) {
					e.wheelDeltaX && (ri.x = -0.16 * e.wheelDeltaX), ri.y = e.wheelDeltaY ? -0.16 * e.wheelDeltaY : -0.16 * e.wheelDelta;
				} else {
					if (!("detail" in e)) {
						return;
					}
		...
		var li, si, ui, ci, di, mi, pi, fi, hi, yi, vi, xi = {history:!0, galleryUID:1}, gi = function () {
			...
			if (ui && clearTimeout(ui), on || X) {
				return ui = setTimeout(Ii, 500), void 0;
			}
			...
			if (fi) {
				...
				-1 === vi.hash.indexOf(e) && (yi = !0), vi.hash = e;
			}
			fi = !0, si = setTimeout(function () {
				ci = !1;
			}, 60);
		};
		Rt("History", {publicMethods:{initHistory:function () {
