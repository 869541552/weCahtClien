...
(function (e, t) {
	...
	"use strict";
	var e = function (e, t) {
		var n, o, i, a, r, l, s, u, c, d, p, m, f, h, v, y, x = this, w = !1, g = !0, b = !0, I = {barsSize:{top:44, bottom:"auto"}, closeElClasses:["item", "caption", "zoom-wrap", "ui", "top-bar"], timeToIdle:4000, timeToIdleOutside:1000, loadingIndicatorDelay:1000, addCaptionHTMLFn:function (e, t) {
			return e.title ? (t.children[0].innerHTML = e.title, !0) : (t.children[0].innerHTML = "", !1);
		}, closeEl:!0, captionEl:!0, fullscreenEl:!0, zoomEl:!0, shareEl:!0, counterEl:!0, arrowEl:!0, preloaderEl:!0, tapToClose:!1, tapToToggleControls:!0, shareButtons:[{id:"facebook", label:"Share on Facebook", url:"https://www.facebook.com/sharer/sharer.php?u={{url}}"}, {id:"twitter", label:"Tweet", url:"https://twitter.com/intent/tweet?text={{text}}&url={{url}}"}, {id:"pinterest", label:"Pin it", url:"http://www.pinterest.com/pin/create/button/?url={{url}}&media={{image_url}}&description={{text}}"}, {id:"download", label:"Download image", url:"{{raw_image_url}}", download:!0}], indexIndicatorSep:" / "}, C = function (e) {
			if (f) {
				return !0;
			}
			e = e || window.event;
		...
		}, Z = [{name:"caption", option:"captionEl", onInit:function (e) {
			i = e;
		...
		x.init = function () {
			...
			r("onVerticalDrag", function (e) {
				g && 0.95 > e ? x.hideControls() : !g && e >= 0.95 && x.showControls();
			});
			var u;
			r("onPinchClose", function (e) {
				g && 0.9 > e ? (x.hideControls(), u = !0) : u && !g && e > 0.9 && x.showControls();
			...
			var c, d, p, f = function (n) {
				for (var o = n.length, i = 0; o > i; i++) {
					...
					for (var a = 0; Z.length > a; a++) {
						p = Z[a], d.indexOf("pswp__" + p.name) > -1 && (e.options[p.option] ? (t.removeClass(c, "pswp__element--disabled"), p.onInit && p.onInit(c)) : t.addClass(c, "pswp__element--disabled"));
					}
				}
			};
			...
			if (!f) {
				if (n.detail && "mouse" === n.detail.pointerType) {
					M(o) && e.close(), t.hasClass(o, "pswp__img") && (1 === e.getZoomLevel() && e.getZoomLevel() <= e.currItem.fitRatio ? e.close() : e.toggleDesktopZoom(n.detail.releasePoint));
				} else {
					if (e.options.tapToToggleControls && (g ? x.hideControls() : x.showControls()), e.options.tapToClose && (t.hasClass(o, "pswp__img") || M(o))) {
